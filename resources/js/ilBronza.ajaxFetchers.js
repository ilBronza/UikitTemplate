...
// =====================================================
// IB FETCHERS (moved from app.blade.php – unchanged)
// =====================================================
...
window.ibFetcherFetch = function (target, warn = false)
{
    ...
    $.ajax({
        ...
        success: function (response)
        {
            ...
            // 🔹 Call page-specific initializer for fetched content
            if (typeof window.ibFetcherInit === 'function') {
                window.ibFetcherInit($('.fetchercontainer.' + id)[0]);
            }
            ...
            if(warn)
            {
                let title = $(target).data('title') || 'Elemento';
